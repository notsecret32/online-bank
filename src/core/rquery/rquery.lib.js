...
class RQuery {
	...
	/**
	 * Find all element that match the specified selector within the selected element.
	 * @param {string} selector - A CSS selector string to search for within the selected element.
	...
	/**
	 * Gets or sets the value of an input elements.
	...
	/**
	 * Hides the selected element by setting the `display` style property to `none`.
	 * @returns {RQuery} The current RQuery instance for chaining.
	 */
	hide() {
